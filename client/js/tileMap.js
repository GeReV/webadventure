define(['sprite', 'resourcemanager'], function(Sprite, ResourceManager) {
  var TileMap = Class.extend({
    ...
    render: function(renderer) {
      ...
      for (var i=0, l1=this.maps.length; i<l1; i++) {
        for (var j=0, l2=this.maps[i].length; j<l2; j++) {
          sprite = this.sprites[ this.map[i][j] ];
          
          renderer.render( sprite, i * tileW, j * tileH );
        }
      }
    }
  });
